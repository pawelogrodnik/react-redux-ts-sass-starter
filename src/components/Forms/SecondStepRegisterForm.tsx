    ...
    return (
        <div className="form form--register">
            <form className="form" onSubmit={handleSubmit}>
                ...
                <Field type="text" wrapperClassName={'quarter'} name="country" component={RegularField} label={'Miasto'} validate={[V.required]} />
                {!localStorage.getItem('salesmanId') && <Field type="text" name="salesmanId" component={RegularField} label={'Identyfikator sprzedawcy'} />}
                <Field wrapperClassName={'half'} name="voivodeship" options={Dictionary.voivodeshipsOptions} component={SelectField} label={'Województwo'} placeholder="Wybierz województwo" validate={[V.required]} />
                ...
                <div className="form--registration__buttons">
                    <button className="btn btn--main btn--left btn--margin-bottom" type="button" onClick={previousPage}>
                        Wróć
                    </button>
                    <button className="btn btn--main btn--right btn--margin-bottom" type="submit" disabled={submitting}>
                        Zarejestruj
                    </button>
                </div>
            </form>
