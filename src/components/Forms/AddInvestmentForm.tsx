                    ...
                    <div className="form--addInvestment_bottom">
                        <div className="form--addInvestment_l">
                            ...
                            <div className="form--addInvestment__content">
                                ...
                                <Field wrapperClassName={'full'} name="detailedParams.images.background" component={FileField} label={'Zdjęcia inwestycji - tło'} />
                                <Field wrapperClassName={'full'} name="detailedParams.images.thumbnail" component={FileField} label={'Zdjęcia inwestycji - thumnbnail'} />
                                <Field wrapperClassName={'full'} name="detailedParams.images.other" multiple component={FileField} label={'Zdjęcia inwestycji - inne'}/>
