            ...
            <form className="form" onSubmit={handleSubmit}>
                <div className="form--addInvestment_l">
                    ...
                    <div className="form--addInvestment__content">
                        <Field type="text" wrapperClassName={'half'} name="seller.companyName" component={RegularField} label={'Nazwa sprzedawcy'} placeholder={'Wpisz nazwę sprzedawcy'} validate={[V.required]} />
                        <Field type="email" wrapperClassName={'half'} name="seller.email" component={RegularField} label={'E-mail sprzedawcy'} placeholder={'Wpisz email sprzedawcy'} />
                    ...
                    <div className="form--addInvestment_bottom">
                        ...
                        <div className="form--addInvestment_r">
                            <div className="form--addInvestment__content form--addInvestment__content--blankTitle">
                                ...
                                <Field type="number" name="detailedParams.priceService" component={RegularField} label={'Cena w serwisie'} placeholder={'Cena w serwisie'} validate={[V.required]} />
                                {(investmentType === flat || investmentType === parcel || investmentType === hotel || investmentType === dorm || investmentType === vehicle || investmentType === franchise) && <Field type="number" name="detailedParams.priceMarket" component={RegularField} label={'Cena rynkowa'} placeholder={'Cena rynkowa'} validate={[V.required]} />}
                                <Field type="number" name="basicParams.provision" component={RegularField} label={'Kwota prowizji'} placeholder={'Kwota prowizji'} validate={[V.required]} />
