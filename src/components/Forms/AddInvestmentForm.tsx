                    ...
                    <div className="form--addInvestment_bottom">
                        <div className="form--addInvestment_l">
                            ...
                            <div className="form--addInvestment__content">
                                ...
                                <Field wrapperClassName={'full'} name="detailedParams.images.background" component={FileField} label={'Zdjęcia inwestycji'} placeholder={'Zdjęcie w tle'} validate={[V.required]} />
                                <Field wrapperClassName={'full'} name="detailedParams.images.thumbnail" component={FileField} label={'Zdjęcia inwestycji'} placeholder={'Thumbnail'} validate={[V.required]} />
                                <Field wrapperClassName={'full'} name="detailedParams.images.other" component={FileField} label={'Zdjęcia inwestycji'} placeholder={'Inne'} validate={[V.required]} />
